...
<div class="create-update-container">
    <div class="form-header">
        <h2><i class="bi bi-pencil-square"></i> Edit Update</h2>
        <p class="text-muted">Modify your update details</p>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('user.updates.update', $update->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select name="task_id" class="form-select">
                        ...
                        @foreach($tasks as $task)
                            <option value="{{ $task->id }}" {{ $update->task_id == $task->id ? 'selected' : '' }}>
                                {{ $task->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="4" required>{{ $update->description }}</textarea>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="Reviewed" {{ $update->status == 'Reviewed' ? 'selected' : '' }}>Reviewed</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="other" class="form-control" value="{{ $update->other }}">
                </div>
            </div>
